...
0. Install the [Gradle build tool](https://gradle.org/); make sure you have a recent [Java JDK](https://bell-sw.com/pages/downloads/#jdk-17-lts) installed and configured for command line use.
